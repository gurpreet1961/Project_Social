<div id="post">
	...
	<div style="width:100%; ">
		<div style="font-weight: bold;color: #405d9b; width:100%; ">
			<?php 
				echo  "<a style='text-decoration: none;'rhref='profile.php?id=$ROW[userid]'>";
		...
		<span style="color: #999; float: right;" >
			...
			if($post->i_own_post($ROW['postid'],$_SESSION['socialsite_userid'])){
				echo "<a href='edit.php?id=$ROW[postid]'>
				Edit 
				</a> .
